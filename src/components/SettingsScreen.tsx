...
import { ArrowLeft, User, Mail, Lock, Image, FileText, UserPlus } from "lucide-react";
      ...
      >
        ...
        <Button
          ...
          className="w-full h-12 rounded-lg text-white font-semibold 
                     bg-[#00A859] hover:bg-[#00914C] active:scale-95
        ...
        <Button
          onClick={() => alert('Novo usuário criado com sucesso')}
          variant="default"
          size="lg"
          className="w-full h-12 mt-4 rounded-lg font-semibold 
                     bg-[#FFD500] text-gray-900 hover:bg-[#E6C200]
